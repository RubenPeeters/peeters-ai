...
<MatchupChart
  id="keystones"
  title="Keystone usage across all 164 Lulu games"
  valueLabel="Games"
  valueSuffix=""
  data={[
    { label: "Electrocute", value: 138, games: 164, detail: "84% — default burst keystone" },
    { label: "Summon Aery", value: 11, games: 164, detail: "7% — into Nautilus, some tanks" },
    { label: "Arcane Comet", value: 8, games: 164, detail: "5% — poke-heavy lanes" },
    { label: "Phase Rush", value: 5, games: 164, detail: "3% — exclusively into Darius/Rumble" },
    { label: "Press the Attack", value: 4, games: 164, detail: "2% — rare, extended trades" },
  ]}
/>
...
<MatchupChart
  id="boots"
  title="Boot choice by opponent category"
  valueLabel="Win rate"
  valueSuffix="%"
  data={[
    { label: "Swiftness → tanks", value: 72, games: 49, detail: "Sion, Zaahen, Vladimir, Fiora, Dr. Mundo" },
    { label: "Merc Treads → AP", value: 67, games: 30, detail: "Aurora, Ryze, Rumble, Ornn" },
    { label: "Steelcaps → AD", value: 63, games: 42, detail: "Irelia, Jax, Renekton, Ambessa, Riven" },
  ]}
/>
